...
class EditAdminBlmMenikah extends StatefulWidget {
  final String noRM;
  EditAdminBlmMenikah({
    this.noRM,
  });
  @override
  _EditAdminBlmMenikahState createState() => _EditAdminBlmMenikahState();
}

class _EditAdminBlmMenikahState extends State<EditAdminBlmMenikah> {
  var data;
