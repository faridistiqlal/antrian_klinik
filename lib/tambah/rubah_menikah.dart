...
class RubahMenikah extends StatefulWidget {
  @override
  _RubahMenikahState createState() => _RubahMenikahState();
}

class _RubahMenikahState extends State<RubahMenikah> {
  bool _loading = false;
  ...
  void rubahmenikah() async {
    String theUrl = getMyUrl.url + 'pasien/RubahKeMenikah';
    var res = await http.post(
      Uri.encodeFull(theUrl),
      headers: {"Accept": "application/json"},
      body: {
        ...
        "ttlpasangan": cTtlPasangan.text + ', ' + cTglPasangan.text,
        "kelamin": kelamin,
        "alamat": alamat,
        "hp": hp,
      },
    ...
    if (responsBody['Status'] == 'UpdateBerhasil') {
      Alert(
        context: context,
        title: "Berhasil",
      ...
      Alert(
        context: context,
        title: "Peringatan",
        desc: "KK Sudah digunakan Keluarga Lain",
