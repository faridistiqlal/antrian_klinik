...
class EditAdminMenikah extends StatefulWidget {
  final String noRM;
  EditAdminMenikah({
    this.noRM,
  });
  @override
  _EditAdminMenikahState createState() => _EditAdminMenikahState();
}

class _EditAdminMenikahState extends State<EditAdminMenikah> {
  var data;
