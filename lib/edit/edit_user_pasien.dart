...
class EditUserPasien extends StatefulWidget {
  final String eNama,
      eAlamat,
      eKelaminSession,
      eHp,
  ...
  @override
  _EditUserPasienState createState() => _EditUserPasienState();
}

class _EditUserPasienState extends State<EditUserPasien> {
